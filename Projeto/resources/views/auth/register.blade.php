                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <table class="table table-striped">
                            <thead>
                                <tr>
                                    <th style="padding-left: 10%"><input type="radio" name="tipo" value="aluno" checked> Aluno</th>
                                    <th style="padding-left: 10%"><input type="radio" name="tipo" value="professor" > Professor</th>
                                    <th style="padding-left: 10%"><input type="radio" name="tipo" value="tecnico"   > Técnico</th>
                                </tr>
                            </thead>
                        </table>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="data_nascimento" type="date" class="form-control" name="data_nascimento" required autocomplete="data-nascimento">
                            </div>
                        </div>
